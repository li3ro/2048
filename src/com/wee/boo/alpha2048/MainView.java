...
//        drawInstructions(canvas);
    ...
    private void createBitmapCells() {
        ...
        for (int xx = 1; xx < bitmapCell.length; xx++) {
            ...
            bitmapCell[xx] = new BitmapDrawable(bitmap);
        }
    }
    ...
    private void createOverlays() {
        ...
        winGameContinueOverlay = new BitmapDrawable(bitmap);
        ...
        winGameFinalOverlay = new BitmapDrawable(bitmap);
        bitmap = Bitmap.createBitmap(endingX - startingX, endingY - startingY, Bitmap.Config.ARGB_8888);
        canvas = new Canvas(bitmap);
        createEndGameStates(canvas, false, false);
        loseGameOverlay = new BitmapDrawable(bitmap);
    }
